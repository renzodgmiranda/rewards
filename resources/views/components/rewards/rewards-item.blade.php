...
<article class="w-72 h-auto place-content-center mr-5">
    <div class="grid gap-3 mt-7 items-center justify-items-center dark:bg-gray-700">
        ...
        <div class="grid justify-items-center items-center rounded-lg bg-gray-100 p-3 text-blue_cus1 w-44 h-36">
        ...
        <div class="grid justify-items-center items-center text-white">
            ...
            <button class="hover:p-5 transition-all p-3 w-56 font-sans font-semibold text-regular bg-orange_cus1 rounded-lg shadow-xl flex items-center justify-center space-x-2" type="button"
